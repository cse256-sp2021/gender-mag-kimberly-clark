...
$('#sidepanel').append('<br><h2>Instructions:</h2>')
$('#sidepanel').append('<p><strong>1.</strong> Identify the file you need to edit permissions for (specified in the task instructions)</p>')
$('#sidepanel').append('<img src="1-01.png" width="100%">')

$('#sidepanel').append('<br><br><p><strong>2.</strong> Click "Edit Permissions" for that file</p>')
$('#sidepanel').append('<img src="2-01.png" width="100%">')

$('#sidepanel').append('<br><br><p><strong>3.</strong> Select the user specified in the task instructions, or click "Add New User"</p>')
$('#sidepanel').append('<p>To remove a user, select that use and then click "Remove User"</p>')
$('#sidepanel').append('<img src="3-01.png" width="50%">')

$('#sidepanel').append('<br><br><p><strong>4.</strong> Look at the permissions for the selected user. Check or uncheck to add or remove permissions.</p>')
$('#sidepanel').append('<p>Only use deny to override gray, inherited permissions</p>')
$('#sidepanel').append('<img src="4-01.png" width="50%">')
